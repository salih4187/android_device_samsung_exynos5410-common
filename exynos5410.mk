...
# Audio configuration
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configsaudio/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/nfc/libnfc-brcm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm.conf
